...
class Deck:
    ...
    def __getattr__(self, name):
        ...
        """
        # TODO: rewrite to be more consise
        if not hasattr(Deck, name):
            if hasattr(self.cards, name):
    ...
    def rising_sequences(self) -> int:
        """
        This property/attribute can be called in an instance of Deck, it will return the number of rising sequences in self.cards (as an integer).
        
        :param None
        :return number of rising sequences as int 
        """
